...
- text: メールアドレス
- textbox "メールアドレス": test-1748935096522-4jql40@example.com
- text: パスワード
- textbox "パスワード": password123-4jql40
- text: パスワード(確認)
- textbox "パスワード(確認)": password123-4jql40
- text: ユーザー名（一意のID）
- textbox "ユーザー名（一意のID）": testuser-1748935096522-4jql40
- button "登録"
- paragraph:
