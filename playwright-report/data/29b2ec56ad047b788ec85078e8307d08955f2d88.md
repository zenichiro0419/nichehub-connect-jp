...
- text: メールアドレス
- textbox "メールアドレス": test-1748935076998-psicih@example.com
- text: パスワード
- textbox "パスワード": password123-psicih
- text: パスワード(確認)
- textbox "パスワード(確認)": password123-psicih
- text: ユーザー名（一意のID）
- textbox "ユーザー名（一意のID）": testuser-1748935076998-psicih
- button "登録"
- paragraph:
