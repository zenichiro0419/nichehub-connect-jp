...
- Name: Signup機能 - バリデーションテスト（異常系） >> 2.3 特殊文字・境界値テスト >> SIGNUP-301: ちょうど8文字のパスワード
- Location: /Users/zenichiro/Develop/github/study/nichehub-connect-jp/src/e2e/signup-validation.spec.ts:219:5
...
Received: "登録エラーアカウント登録に失敗しました: email rate limit exceeded"
    at /Users/zenichiro/Develop/github/study/nichehub-connect-jp/src/e2e/signup-validation.spec.ts:239:28
```
...
- text: パスワード
- textbox "パスワード": abcd1234
- text: パスワード(確認)
- textbox "パスワード(確認)": abcd1234
- text: ユーザー名（一意のID）
...
- region "Notifications (F8)":
  - list:
    - status:
      - text: "登録エラー アカウント登録に失敗しました: email rate limit exceeded"
      - button:
        - img
```
