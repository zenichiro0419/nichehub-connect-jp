...
- text: メールアドレス
- textbox "メールアドレス": test-1748935061023-weflum@example.com
- text: パスワード
- textbox "パスワード": password123-weflum
- text: パスワード(確認)
- textbox "パスワード(確認)": password123-weflum
- text: ユーザー名（一意のID）
- textbox "ユーザー名（一意のID）": testuser-1748935061023-weflum
- button "登録"
- paragraph:
