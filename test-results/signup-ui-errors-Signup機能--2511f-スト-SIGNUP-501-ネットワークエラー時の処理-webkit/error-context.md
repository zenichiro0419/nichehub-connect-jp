...
Received string:  "登録エラーアカウント登録に失敗しました: load failed"
...
- text: メールアドレス
- textbox "メールアドレス": test-1748935046509-25pnkn@example.com
- text: パスワード
- textbox "パスワード": password123-25pnkn
- text: パスワード(確認)
- textbox "パスワード(確認)": password123-25pnkn
- text: ユーザー名（一意のID）
- textbox "ユーザー名（一意のID）": testuser-1748935046509-25pnkn
- button "登録"
- paragraph:
...
- region "Notifications (F8)":
  - list:
    - status:
      - text: "登録エラー アカウント登録に失敗しました: Load failed"
      - button:
        - img
```
