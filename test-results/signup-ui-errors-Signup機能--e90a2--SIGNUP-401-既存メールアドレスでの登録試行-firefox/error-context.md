...
Received string:  "登録エラーアカウント登録に失敗しました: email address \"existing@example.com\" is invalid"
...
- region "Notifications (F8)":
  - list:
    - status:
      - text: "登録エラー アカウント登録に失敗しました: Email address \"existing@example.com\" is invalid"
      - button:
        - img
```
